...
<br/>
<input name="choice" type="radio" value="1" />Addition<br/>
<input name="choice" type="radio" value="2" />Subtraction<br/>
<input name="choice" type="radio" value="3" />Multiplication<br/>
<input name="choice" type="radio" value="4" />Division<br/>
<input name="choice" type="radio" value="5" />Modulus<br/>
